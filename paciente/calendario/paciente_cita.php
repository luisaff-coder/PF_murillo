                ...
                <div class="cardt rounded-0 shadow">
                    ...
                    <div class="card-body">
                        <div class="container-fluid">
                            <form action="guarda_cita.php" method="post" id="schedule-form">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <input type="datetime-local" class="form-control form-control-sm rounded-0" name="fecha_cita" id="fecha_cita" required>
                                </div>
