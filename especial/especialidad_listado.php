...
?>
    ...
    <br><a style="margin-left:20px"  class="btn btn-primary mt-1" href="../admin/index_admin.php?page=../especial/especialidad_formulario.php"><i class="fa-solid fa-user-tie fa-2x"></i>  Agregar</a> <br> <br>
    <div class="card">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                            <a href="../admin/index_admin.php?page=../especial/especialidad_formulario2.php&id=<?php echo $fila['id']; ?>" class="btn btn-warning btn-sm"><i class="fa-solid fa-pen-to-square fa-2x"></i>  Editar</a>
                            <a href="../especial/especialidad_CRUD.php?id=<?php echo $fila['id'];  ?>" onclick="return confirm('¿Estás Segur@ de Borrar?')" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash-can fa-2x"></i>  Eliminar</a>
                            </td>
                        </tr>
                    <?php
                    }
