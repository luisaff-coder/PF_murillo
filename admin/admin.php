...
<link rel="stylesheet" href="../public/bootstrap-5.3/css/bootstrap.min.css">
    ...
    <div class="card" style="margin: 0 auto;">
        ...
        <div class="card-body" >
            <form id="Form" action="otros/CRUD.php" method="post" enctype="multipart/form-data">
                ...
                <br>
                <button type="submit" name="loginAdmin" class="btn btn-success " value="LoginAdmin" style="font-size: 20px;"><img src="./iconos/guardar.png" width="50" height="50"> Iniciar sesion</button>
    ...
    $("#Form").validate({
        ...
        messages:{
            ...
            minlength: "El correo debe tener un minimo de 3",
            maxlength: "El correo debe tener un maximo de 40"
            },
