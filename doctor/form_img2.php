...
if (isset($_POST['btnactualizar'])) {
    ...
    if (move_uploaded_file($_FILES['imagen']['tmp_name'], $target_file)) {
        $sql = "UPDATE doctores SET imagen = '$target_file' WHERE id = $id";
...
$id = $_GET['id'] ?? null;
if ($id) {
    $stmt = $conexion->prepare("SELECT nombres, imagen FROM doctores WHERE id = ?");
...
<div class="container mt-5">
    ...
    <form action="../doctor/form_img2.php" method="POST" enctype="multipart/form-data">
