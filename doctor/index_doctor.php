                ...
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        <li class="nav-item menu-open"> <a href="#" class="nav-link active"> <i class="nav-icon bi bi-speedometer"></i>
                            ...
                            <li class="nav-item"> <a href="index_doctor.php?page=../doctor/datos.php" class="nav-link active"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Mis Datos</p>
                                    </a> </li>
                                <li class="nav-item"> <a href="index_doctor.php?page=../doctor/dias.php" class="nav-link active"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Dias trabajados</p>
                                    </a> </li>
                                <li class="nav-item"> <a href="index_doctor.php?page=../especial/0.php" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Consultas</p>
                                    </a> </li>
                                <li class="nav-item"> <a href="index_doctor.php?page=../especial/0.php" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Consultas</p>
